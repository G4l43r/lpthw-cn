...
want milk, eggs, bread, and soup."  Only as a programmer we can say, "(milk,
eggs, bread, soup)" and be done with it.
...
cryptic variable names, so lets get you started being able to read and write
them early on.
