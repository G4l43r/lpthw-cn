...
In this exercise you'll be taking the logic exercises you memorized and start trying 
...
Once you have the answers written down, you'll start ``python`` in your terminal and
...
After you've tried to guess at these this is what your session with ``python``
might look like:
