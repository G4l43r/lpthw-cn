...
expressions.  They're named after George Boole who invented the concepts and they are
...
.. warning::
    ...
    be able to give a good first stab at solving them, but do not
    ...
    Just stick with it, keep track of what you get wrong, but do not worry
...
3. Play with the ``python`` by typing out new boolean operators, and before you
   hit enter try to just shout out what it is.  Do not think about it, just the
   first thing that comes to mind.  Write it down then hit enter, and keep
   track of how many you get right and wrong.
4. Throw that piece of paper from #3 away so you do not accidentally try to use it later.
