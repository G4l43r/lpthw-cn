...
3. What happens if it isn't indented?
   If it isn't indented, then you will most likely create a Python error.  Python
...
5. What happens if you change the initial variables for ``people``, ``cats``, and
   ``dogs``?
   Because you are comparing numbers, if you change the numbers then different ``if-statements``
