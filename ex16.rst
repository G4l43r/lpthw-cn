...
That's a large file, probably the largest you've typed in.  So go slow, do
...
There are actually two things you'll see, first the output of your new
script:
...
3. There's to much repetition in this file.  Use strings, formats, and escapes
