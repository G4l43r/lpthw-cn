...
* Line 5 you import *your* ``ex25.py`` python file, just other imports you have done.  Notice you don't need to put the ``.py`` at the end to import it.  When you do this you make a ``module`` that has all your functions in it to use.
