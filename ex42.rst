...
like I will show you here.  See also how we then use this in ``add_me_up()`` later
...
Here's how we would do exercise 41 using classes instead of the thing
we created:
...
the same.  Compare this new version of the game and with
