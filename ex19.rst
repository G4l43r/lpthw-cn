...
Functions may have been a mind blowing amount of information, but don't worry
just keep doing these exercises and going through your checklist from the last
exercise and you'll eventually get it.
...
when we make a variable.  In fact, if you can use ``=`` to name something then
you can usually pass it to a function as an argument.

What You Should See
===================

You should study the output of this script and compare it to what you
...
3. Write at least one more function of your own design, and call it 10 different ways.
