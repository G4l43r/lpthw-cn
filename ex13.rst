...
in programming.  You'll find it used in many other languages.  What this
variable does is *hold* the arguments you pass to your Python script when you
run it.  In the exercises you'll get to play with this more and see what
happens.
...
If you don't run it correctly, then you'll get an error like this:
