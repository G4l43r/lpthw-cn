Exercise 41: A Room With A View
*******************************

Did you figure out the secret of the function in the dict from the
last exercise?  Could you explain it to yourself?  Let me explain it
and you can compare your explanation with mine.  Here's the lines of
...
another variable name in your current module that you can then use anywhere.  In
...
6. ``find_city`` then tries to lookup ``states`` inside ``cities``, and returns
...
code.  I just glance at it and I know what it means, and I can even glance at a whole
