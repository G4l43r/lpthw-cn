...
3.  Instead of having each function print itself, learn about "doc comments".  Write the room description as doc comments, and change the runner to print them.
