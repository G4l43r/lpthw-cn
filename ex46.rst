...
This will also be where you start learning how to setup a good project "skeleton"
...
modules, and install scripts.  When you go to make a new project, you just copy
this directory to a new name and edit the files to get started.

Skeleton Contents: Linux/OSX
============================

You first want to create the structure of your skeleton directory with these 
commands:
...
renamed to whatever you're calling your project's main module when you 
use the skeleton.
...
You should edit this file so that it has your contact information in it
...
Coming soon...I need a windows computer to test this but it should be similar
to the Linux/OSX instructions.


Installing Python Packages
--------------------------

You'll want to make sure you have some packages installed that makes
...
Don't just download these packages and install them by hand.  Instead see how 
...
but you can't install pacakages until you install package installers, and you can't
...
for now if you don't see that then you probably got something wrong.  Make sure
...
3. Make a project and start putting code into the module you have, then get the 
   module working.
